...
const Navbar = ({ isMobile, toggleSidebar, onNavClick }) => {
  ...
  const [navbarColor, setNavbarColor] = useState('bg-red-500'); // fallback default
  ...
  return (
    <nav className={`${navbarColor} text-white p-4 flex justify-between items-center shadow-md relative`}>
      ...
      {!isMobile && (
        <div className="flex space-x-4">
          <Link to="/" onClick={() => onNavClick("Home")}className="px-4 hover:text-gray-300">Home</Link>
            ...
            <li>
              ...
              {activeMenu === "Attendance" && (
                <ul className="ml-4 bg-gray-800 p-2 rounded-md">
                  ...
                  {/* <li>
                    <Link to="/setting" className="block py-2 hover:bg-gray-700" onClick={() => setMobileMenuOpen(false)}>
